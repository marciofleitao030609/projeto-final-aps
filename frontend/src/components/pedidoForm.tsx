  ...
  return (
    <div className="p-4 border rounded">
      ...
      <form onSubmit={(e) => e.preventDefault()} className="mb-4">
        ...
        <button type="button" onClick={handleAddPizza} className="bg-green-500 text-white p-2 w-full rounded hover:bg-green-600 transition duration-200">
          Adicionar Pizza
        </button>
      </form>
      ...
      {/* Botões configurados corretamente */}
      <div className="flex gap-2">
        ...
        <button
          ...
          className="bg-red-500 text-white p-2 w-full rounded hover:bg-red-600 transition duration-200"
        >
          Limpar Dados
        </button>
      </div>
